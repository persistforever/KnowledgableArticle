...
def create_title_texts(artice_path, split_path, dictionary_path, texts_path) :
    corpus = Corpus()
    corpus.article_info(artice_path, type='load')
    corpus.participle_list(split_path, type='load', target='participle_title')
...
if __name__ == '__main__' :
    ...
    create_title_texts(article, split, dictionary, texts)