...
public class UserTagRun {
	...
	public UserTagRun(String pyqpath, String poipath, String mainpath,
	...
	public static void main(String[] args) throws IOException,
		...
		String date = args[3];
		String day = args[4];
		UserTagRun run = new UserTagRun(pyqpath, poipath, mainpath, date, day);
		run.run();
	}
	...
	public void run() throws IOException, ClassNotFoundException,
		...
		this.outputList = Week.Input(
				HadoopFileOperation.CatPath(this.mainpath, date), date, day);
